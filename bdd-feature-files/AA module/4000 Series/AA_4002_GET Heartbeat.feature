Feature: On calling GET Heart beat request API,Verify that on sending a valid
  heartbeat request as an FIU, success response is received.

  Scenario: 4002_1 On calling GET Heart beat request API,sending a valid heartbeat
  request as an FIU, success response is received.
