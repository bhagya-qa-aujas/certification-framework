Feature: On calling FIP and FIU Notifications API, verify that on sending a valid FI request,
  FI notification with READY status is sent back to FIU.

  Scenario: 2018_1 On calling FIP and FIU Notifications API, use the pre-generated consent details from settings and set a
