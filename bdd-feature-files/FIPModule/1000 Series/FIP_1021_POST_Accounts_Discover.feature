Feature: On Calling POST Account discovery API with valid customer id, all supported FITypes and strong customer
  ...
  Scenario: 1021_1 On Calling POST Account discovery with strong identifier MOBILE for a user with one account
  ...
  Scenario: 1021_2 On Calling POST Account discovery with strong identifier MOBILE for a user with two accounts
  ...
  Scenario: 1021_3 On Calling POST Account discovery with strong identifier MOBILE for a user with three accounts
