Feature: On Calling POST FI Request using consent that is not active and check if it is responding
  ...
  Scenario: 3011_3 Use the pre-linked user details from settings, set Consent/notification response in mock
  server, send one valid consent post request  and try the following. Send POST Account FIRequest with value
  ...
  Scenario: 3011_4 Use the pre-linked user details from settings, set Consent/notification response in mock
  server, send one valid consent post request  and try the following. Send POST Account FIRequest with value
  ...
  Scenario: 3011_5 Use the pre-linked user details from settings, set Consent/notification response in mock
  server, send one valid consent post request  and try the following. Send POST Account FIRequest with value
