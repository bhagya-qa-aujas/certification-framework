Feature: Send FI request and FI fetch request for consents created for all combinations of the
  ...
  Scenario: 3014_1 Use the pre-linked user details from settings and try the following
  ...
  Scenario: 3014_2 Use the pre-linked user details from settings and try the following
  1. Set Consent/notification response in mock server, Post consent with each valid combination of
  consentType.Set Fi/Notification response on mock server. Then send the FI request, wait for FI ready
  notification and then send FI fetch request. Send FI Fetch request for response validation of FI data must
  ...
  Scenario: 3014_3 Use the pre-linked user details from settings and try the following
  1. Set Consent/notification response in mock server, Post consent with each valid combination of
  consentType.Set Fi/Notification response on mock server. Then send the FI request, wait for FI ready
  notification and then send FI fetch request. Send FI Fetch request for response validation of FI data must
  ...
  Scenario: 3014_4 Use the pre-linked user details from settings and try the following
  1. Set Consent/notification response in mock server, Post consent with each valid combination of
  consentType.Set Fi/Notification response on mock server. Then send the FI request, wait for FI ready
  notification and then send FI fetch request. Send FI Fetch request for response validation of FI data must
  ...
  Scenario: 3014_5 Use the pre-linked user details from settings and try the following
  1. Set Consent/notification response in mock server, Post consent with each valid combination of
  consentType.Set Fi/Notification response on mock server. Then send the FI request, wait for FI ready
  notification and then send FI fetch request. Send FI Fetch request for response validation of FI data must
  ...
  Scenario: 3014_6 Use the pre-linked user details from settings and try the following
  1. Set Consent/notification response in mock server, Post consent with each valid combination of
  consentType.Set Fi/Notification response on mock server. Then send the FI request, wait for FI ready
  notification and then send FI fetch request. Send FI Fetch request for response validation of FI data must
  ...
  Scenario: 3014_7 Use the pre-linked user details from settings and try the following
  1. Set Consent/notification response in mock server, Post consent with each valid combination of
  consentType.Set Fi/Notification response on mock server. Then send the FI request, wait for FI ready
  notification and then send FI fetch request. Send FI Fetch request for response validation of FI data must
