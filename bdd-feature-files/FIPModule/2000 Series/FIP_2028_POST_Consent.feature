Feature: On Calling POST Consent request as regular AA with selected details of alternate AA, error
  ...
  Scenario: 2028_1 Use the pre-linked user details from settings, generate one valid consent post request
  ...
  account, get the received OTP from user, send a valid account link verify request(Do all above as alternate
  ...
  Scenario: 2028_2 Use the pre-linked user details from settings, generate one valid consent post request
  for regular AA and try the following variations while sending the request as regular AA. Prerequisite: Do
  an account discover request for user with two account, send a valid account link request for discovered
  account, get the received OTP from user, send a valid account link verify request(Do all above as alternate
  ...
  Scenario: 2028_3 Use the pre-linked user details from settings, generate one valid consent post request
  for regular AA and try the following variations while sending the request as regular AA. Prerequisite: Do
  an account discover request for user with two account, send a valid account link request for discovered
  account, get the received OTP from user, send a valid account link verify request(Do all above as alternate
  ...
  Scenario: 2028_4 Use the pre-linked user details from settings, generate one valid consent post request
  for regular AA and try the following variations while sending the request as regular AA. Prerequisite: Do
  an account discover request for user with two account, send a valid account link request for discovered
  account, get the received OTP from user, send a valid account link verify request(Do all above as alternate
  ...
  Scenario: 2028_5 Use the pre-linked user details from settings, generate one valid consent post request
  for regular AA and try the following variations while sending the request as regular AA. Prerequisite: Do
  an account discover request for user with two account, send a valid account link request for discovered
  account, get the received OTP from user, send a valid account link verify request(Do all above as alternate
  ...
  Scenario: 2028_6 Use the pre-linked user details from settings, generate one valid consent post request
  for regular AA and try the following variations while sending the request as regular AA. Prerequisite: Do
  an account discover request for user with two account, send a valid account link request for discovered
  account, get the received OTP from user, send a valid account link verify request(Do all above as alternate
